...
class AdminController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/administrator')->with('success', 'Berhasil Menambah Data Administrator !!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/administrator')->with('success', 'Berhasil Edit Data Administrator !!');
    }
    ...
    public function destroy($id, Request $request)
    {
        ...
        return redirect('/administrator')->with('success', 'Berhasil Menghapus Data administrator !!');
    }
}
