                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="col-8">
                                <div class="row">
                                    <div class="col-1">
                                        <a href="/dashboard" title="Kembali">
                            ...
                            <div class="col-4 d-flex justify-content-end">
                                <a href="{{ url('change-password') }}" class="text-white">
                                    <button type="button" class="btn btn-primary" data-toggle="tooltip"
                                        data-placement="top" title="Edit Profile" data-original-title="Edit Profile">
                        ...
                        <div class="card-body ">
                            <div action="/profile" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                        ...
                                        @if ($data->foto)
                                            <div class="d-flex justify-content-center mt-3 ml-3">
                                                <img src="{{ asset('storage/' . $data->foto) }}"
                                                    alt="foto {{ $data->nama }}" class="foto-user foto-user-detail">
                                            </div>
                                        @else
                                            <div class="d-flex justify-content-center mt-3 ml-3">
